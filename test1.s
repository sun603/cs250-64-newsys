...
/*ldr r0, =print_string    Load r0 with the address symbolized by "print_string", the first byte */
/*  of the Hello World string in the data segment.  Printf will use this. */ 
/*bl printf    Branch with link to "printf". Saves pc into lr then branches to printf. */
ldp x29,x30,[sp], #16; /* Restore registers r4 through r9, fp and pc allowing graceful return     */
ret;
